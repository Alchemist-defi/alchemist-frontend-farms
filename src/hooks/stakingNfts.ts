...
// approve staking
export const useStakingDeposit = (stakingContract: Contract) => {
  const { account } = useWallet()
  const onDeposit = useCallback(async (tokenId) => {
    console.log('%c 🍪 tokenId: ', 'font-size:20px;background-color: #42b983;color:#fff;', tokenId);
    try {
