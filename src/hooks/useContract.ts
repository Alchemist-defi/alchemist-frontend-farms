...
import { getMasterChefAddress, getCakeAddress, getLotteryAddress, getLotteryTicketAddress, getAurumMasterChefAddress } from 'utils/addressHelpers'
...
import aurumMasterChef from 'config/abi/aurumMasterchef.json'
...
export const useAurumMasterchef = () => {
  const abi = (aurumMasterChef as unknown) as AbiItem
  return useContract(abi, getAurumMasterChefAddress())
}
